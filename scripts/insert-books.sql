...
INSERT INTO books (title, author) VALUES ('Frankenstein', 'Mary Shelley');
...
INSERT INTO books (title, author) VALUES ('Project Hail Mary', 'Andy Weir');

-- 13. Circe by Madeline Miller
INSERT INTO books (title, author) VALUES ('Circe', 'Madeline Miller');

-- 14. The House in the Cerulean Sea by T.J. Klune
INSERT INTO books (title, author) VALUES ('The House in the Cerulean Sea', 'T.J. Klune');

-- 15. The Midnight Library by Matt Haig
INSERT INTO books (title, author) VALUES ('The Midnight Library', 'Matt Haig');
...
INSERT INTO books (title, author) VALUES ('Caste: The Origins of Our Discontents', 'Isabel Wilkerson');

-- 20. Braiding Sweetgrass: Indigenous Wisdom, Scientific Knowledge and the Teachings of Plants by Robin Wall Kimmerer
INSERT INTO books (title, author) VALUES ('Braiding Sweetgrass: Indigenous Wisdom, Scientific Knowledge and the Teachings of Plants', 'Robin Wall Kimmerer');
